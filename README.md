...
const gabriel = {
  ...
  experience: {
    total_it: "5+ years",
    development: "4+ years",
    specialty: "E-commerce Platforms & Design Systems"
  },

  education: {
    degree: "Computer Networks (Bachelor)",
    institution: "FATEC",
    year: 2022
  },

  expertise: [
    "E-commerce Development & Architecture",
    "Landing Pages (SEO & Conversion)",
    "Management Dashboards",
    "Checkout Systems & Payment Flows",
    "Authentication & Authorization Systems",
    "Design Systems & Component Libraries"
  ],

  principles: [
    "Clean Code & SOLID mindset",
    "Performance-first architecture",
    "Accessibility & semantic HTML",
    "Predictable state & testable behavior",
    "Operational maturity & error boundaries"
  ],

  professionalHighlights: [
    "Led high-impact projects with React, Next.js & Angular",
    "Focused on e-commerce solutions & custom platforms",
    "Strong focus on performance, security & best practices"
  ]
};
```
...
<p align="center">
  <a href="https://www.linkedin.com/in/gabriel-messias-44b70018b/" target="_blank" rel="noopener noreferrer">
...
- ⚙️ **What I do:** React/Next.js applications
...
<div align="center">
```
  💻 5+ years in IT | 4+ years as Developer
...
## 📊 GitHub Stats
<div align="center">
  <img height="180em" src="https://github-readme-stats.vercel.app/api?username=messiasgabriel&show_icons=true&theme=tokyonight&include_all_commits=true&count_private=true"/>
  <img height="180em" src="https://github-readme-stats.vercel.app/api/top-langs/?username=messiasgabriel&layout=compact&theme=tokyonight&hide=jupyter%20notebook"/>
</div>

<div align="center">
  <img src="https://github-readme-streak-stats.herokuapp.com/?user=messiasgabriel&theme=tokyonight" alt="GitHub Streak" />
</div>
--!>
